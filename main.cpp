...
int main(int argc, char* argv[]){
    ...
    //On choisit arbitrairement le ratio et la largeur de l'image
    ...
    // Vecteurs de la caméra allant de gauche à droite et de haut en bas
    auto viewport_u = vec3(viewport_width, 0, 0);
    auto viewport_v = vec3(0, -viewport_height, 0);

    // Vecteurs delta allant de pixel en pixel
    auto pixel_delta_u = viewport_u / image_width;
    auto pixel_delta_v = viewport_v / image_height;

    // Coordonnées du pixel en haut à gauche
